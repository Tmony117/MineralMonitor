...
If you discover a security vulnerability in Mineral Monitor, please report it responsibly:
...
Mineral Monitor is a client-side intelligence dashboard that aggregates publicly available data. Here are the key security areas:
...
- Mineral Monitor aggregates publicly available OSINT data
...
- Vulnerabilities in the Mineral Monitor codebase
...
Thank you for helping keep Mineral Monitor and its users safe! 🔒
