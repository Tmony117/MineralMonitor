...
export const VARIANT_DEFAULTS: Record<string, string[]> = {
  ...
  full:      Object.keys(MINERALS_PANELS), // Keep full as a fallback alias to minerals for safety
};
...
export const DEFAULT_MAP_LAYERS = MINERALS_MAP_LAYERS;

export const MOBILE_DEFAULT_MAP_LAYERS = MINERALS_MOBILE_MAP_LAYERS;
