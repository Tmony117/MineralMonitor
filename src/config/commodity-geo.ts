...
export const MINING_SITES: MineSite[] = [
  ...
  },
  {
    ...
    operator: 'Newmont',
    status: 'producing',
    significance: 'Newmont\'s newest Ghanaian gold mine. Open-pit operation in the Birim North District.',
  ...
  },
  {
    ...
    status: 'producing',
    significance: 'One of Ghana\'s largest surface gold mines. Leveraged CIL/CIP processing.',
  ...
  },
  {
    ...
    operator: 'Gold Fields',
    status: 'producing',
    significance: 'Gold Fields operation adjacent to Tarkwa. Expansion into high-grade underground.',
    annualOutput: '250 Koz/yr',
    openPitOrUnderground: 'both',
  },
  {
    id: 'chirano',
    ...
    mineral: 'Gold',
    country: 'Ghana',
    operator: 'Asante Gold',
    status: 'producing',
    significance: 'Underground gold mine in Western Region. Previously operated by Red Back / Kinross.',
    annualOutput: '150 Koz/yr',
    openPitOrUnderground: 'underground',
  },
  {
    id: 'bibiani',
    ...
    operator: 'Asante Gold',
    status: 'producing',
    significance: 'Resurrected underground gold mine in Western North Region. Historical producer from 1900s.',
    annualOutput: '100 Koz/yr',
    openPitOrUnderground: 'underground',
  },
  {
    id: 'awaso',
    ...
    mineral: 'Aluminum',
    country: 'Ghana',
    operator: 'Ghana Bauxite Company',
    status: 'producing',
    significance: 'Ghana\'s only producing bauxite mine. Feed for domestic alumina refinery potential.',
    openPitOrUnderground: 'open-pit',
  },
  {
    id: 'nsuta',
    ...
    mineral: 'Manganese',
    country: 'Ghana',
    operator: 'Ghana Manganese Company',
    status: 'producing',
    significance: 'One of Africa\'s largest manganese producers. Key export via Takoradi port.',
    openPitOrUnderground: 'open-pit',
  },

  // === ECOWAS (non-military rule) — Côte d\'Ivoire ===
  {
    id: 'tongon',
    name: 'Tongon',
    lat: 9.42,
    ...
    status: 'producing',
    significance: 'Largest gold mine in Côte d\'Ivoire. Open-pit with plant expansion.',
    annualOutput: '250 Koz/yr',
    openPitOrUnderground: 'open-pit',
  },
  {
    ...
    status: 'producing',
    significance: 'Key Endeavour operation in central Côte d\'Ivoire. Transitioning to underground.',
    annualOutput: '140 Koz/yr',
    openPitOrUnderground: 'both',
  },
  {
    id: 'ity',
    ...
    operator: 'Endeavour Mining',
    status: 'producing',
    significance: 'Long-life Endeavour asset in western Côte d\'Ivoire. CIL plant expansion completed.',
    annualOutput: '280 Koz/yr',
    openPitOrUnderground: 'open-pit',
  },
  {
    id: 'lafigue',
    ...
    operator: 'Endeavour Mining',
    status: 'development',
    significance: 'Major development project. Expected to become one of Côte d\'Ivoire\'s largest gold mines.',
    openPitOrUnderground: 'open-pit',
  },

  // === ECOWAS (non-military rule) — Senegal ===
  {
    id: 'sabodala-massawa',
    ...
    operator: 'Endeavour Mining',
    status: 'producing',
    significance: 'Senegal\'s largest gold mine. Endeavour flagship asset in West Africa.',
    annualOutput: '350 Koz/yr',
    openPitOrUnderground: 'open-pit',
  },
  {
    id: 'mako',
    ...
    status: 'producing',
    significance: 'High-grade open-pit gold mine in eastern Senegal near Mali border.',
    annualOutput: '150 Koz/yr',
    openPitOrUnderground: 'open-pit',
  },

  // === ECOWAS (non-military rule) — Sierra Leone ===
  {
    id: 'marampa',
    name: 'Marampa',
    lat: 8.62,
    ...
    operator: 'Gerald Group',
    status: 'producing',
    significance: 'Recommissioned iron ore mine. Key Sierra Leone export via Pepel port.',
    openPitOrUnderground: 'open-pit',
  },
  {
    id: 'tonkolili',
    ...
    mineral: 'Iron Ore',
    country: 'Sierra Leone',
    operator: 'Kingho Investment',
    status: 'producing',
    significance: 'World-class magnetite iron ore deposit. China-backed revival post-2019.',
    openPitOrUnderground: 'open-pit',
  },

  // === ECOWAS (non-military rule) — Liberia ===
  {
    id: 'new-liberty',
    name: 'New Liberty',
    lat: 6.85,
    ...
    mineral: 'Gold',
    country: 'Liberia',
    operator: 'Avesoro Resources',
    status: 'producing',
    significance: 'Liberia\'s first commercial gold mine. Shear-hosted deposit in the Birimian belt.',
    annualOutput: '100 Koz/yr',
    openPitOrUnderground: 'open-pit',
  },
  {
    ...
    status: 'producing',
    significance: 'Liberia\'s largest iron ore mine. Connected to Buchanan port via rail.',
    openPitOrUnderground: 'open-pit',
  },

  // === ECOWAS (non-military rule) — Nigeria ===
  {
    id: 'itakpe',
    name: 'Itakpe',
    lat: 7.62,
    ...
    mineral: 'Iron Ore',
    country: 'Nigeria',
    operator: 'National Iron Ore Mining Company',
    status: 'producing',
    significance: 'Nigeria\'s largest iron ore deposit. Ajaokuta steel plant feed source.',
    openPitOrUnderground: 'open-pit',
  },

  // === ECOWAS (non-military rule) — Togo ===
  {
    id: 'tabligbo',
    name: 'Tabligbo',
    lat: 6.58,
    ...
    mineral: 'Aluminum',
    country: 'Togo',
    operator: 'Cimtogo / WACEM',
    status: 'producing',
    significance: 'Togo\'s main limestone and phosphate quarrying region. Clinker and cement production hub.',
    openPitOrUnderground: 'open-pit',
  },
...
export const PROCESSING_PLANTS: ProcessingPlant[] = [
  ...
  // Ghana / ECOWAS Processing
  {
    id: 'takoradi-smelter',
    name: 'Takoradi Gold Refinery',
    lat: 4.89,
    lon: -1.75,
    type: 'refinery',
    mineral: 'Gold',
    country: 'Ghana',
    operator: 'Ghana Gold Refinery / PMMC',
    status: 'operating',
    significance: 'Ghana\'s primary gold refinery. LBMA-accredited good delivery status.',
    outputCapacity: '~50t gold/yr',
  },
  {
    id: 'valco-tema',
    name: 'VALCO (Volta Aluminum Company)',
    lat: 5.64,
    lon: -0.01,
    type: 'smelter',
    mineral: 'Aluminum',
    country: 'Ghana',
    operator: 'Ghana Integrated Aluminium Development Corporation',
    status: 'operating',
    significance: 'Ghana\'s only aluminum smelter. Currently operating below capacity; expansion planned with bauxite integration.',
    outputCapacity: '40kt Al/yr (expansion to 200kt planned)',
  },
];
...
export const COMMODITY_PORTS: CommodityPort[] = [
  ...
  // ECOWAS Ports
  {
    ...
    country: 'Ghana',
    city: 'Takoradi',
    commodities: ['Gold', 'Manganese', 'Aluminum'],
    significance: 'Ghana\'s primary mineral export port. Manganese and bauxite gateway for industrial minerals.',
  },
  {
    id: 'buchanan-liberia',
    name: 'Buchanan Port',
    ...
    city: 'Buchanan',
    commodities: ['Iron Ore'],
    significance: 'ArcelorMittal iron ore export terminal. Connected to Yekepa mine by 250km rail.',
  },
  {
    id: 'pepel-sierra-leone',
    name: 'Pepel Port',
    lat: 8.58,
    lon: -13.06,
    country: 'Sierra Leone',
    city: 'Pepel',
    commodities: ['Iron Ore'],
    significance: 'Sierra Leone iron ore export terminal. Serves Marampa and Tonkolili mines.',
  },
  {
    id: 'san-pedro-civ',
    name: 'San Pedro Port',
    ...
    significance: 'Deep-water port serving southwestern Côte d\'Ivoire mining operations.',
  },
  {
    id: 'dakar-senegal',
    name: 'Port of Dakar',
    ...
    city: 'Dakar',
    commodities: ['Gold'],
    significance: 'Primary mineral export gateway for Senegal. Gold concentrate from Sabodala-Massawa.',
  },
  {
    id: 'lagos-nigeria',
    ...
    country: 'Nigeria',
    city: 'Lagos',
    commodities: ['Iron Ore', 'Lead', 'Zinc'],
    significance: 'Nigeria\'s busiest port. Handles mineral imports for steel industry and limited exports.',
  },
];
