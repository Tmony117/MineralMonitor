# Component Documentation — Mineral Monitor
...
Mineral Monitor's UI is built entirely with **vanilla TypeScript** — no React, Vue, or
...
Mineral Monitor ships two independent map renderers and an adapter that picks the
