# Mineral Monitor — Feature & Improvement Roadmap
...
- **Priority:** 🟢 Low | **Effort:** ~4 hours
- Redesign the `story-share.ts` OG card template with richer previews: map snapshot, event title, CII score, and Mineral Monitor branding.
