...
Mineral Monitor runs five thematic variants from a single codebase, each tailored to a different audience:

| Variant | Domain | Focus |
|---------|--------|-------|
| **Mineral Monitor** | worldmonitor.app | Geopolitics, military, conflicts, infrastructure |
...
Mineral Monitor uses a multi-tier AI pipeline to process and summarize information:
...
Mineral Monitor aggregates publicly available data from dozens of sources. No proprietary or classified information is used. Key source categories:
...
Mineral Monitor serves several audiences:
...
| Feature | Mineral Monitor | Traditional OSINT Tools | News Aggregators |
|---------|--------------|------------------------|-----------------|
...
Mineral Monitor is actively developed with planned expansions across several areas:
...
- **API access** for developers and organizations to integrate Mineral Monitor data into their own tools
...
**Q: Where does Mineral Monitor get its data?**
...
**Q: Does Mineral Monitor track users or sell data?**
...
A: Yes. Mineral Monitor is licensed under AGPL-3.0, meaning anyone can inspect, audit, modify, and redistribute the code. If you run a modified version as a service, you must share your modifications under the same license.

**Q: Who built this?**
A: Mineral Monitor was created by Elie Habib. It is an independent project, not affiliated with any government, intelligence agency, or defense contractor.

**Q: Can I embed Mineral Monitor or use its data in my reporting?**
A: The web interface can be referenced and linked in reporting. For data integration, an API tier is planned. Please attribute "Mineral Monitor (worldmonitor.app)" when referencing the platform in published work.

**Q: How is this different from Janes, Palantir, or Dataminr?**
A: Those are enterprise products costing tens to hundreds of thousands of dollars per year, typically sold to governments and large corporations. Mineral Monitor aims to democratize access to situational awareness by aggregating public data and using AI to make it digestible. It is open source, free to use, and designed for individual analysts and small teams, not just large organizations.
...
A: Mineral Monitor is primarily a solo project by its creator, with occasional open-source contributions from the community.
...
*This document was last updated March 2026. Mineral Monitor is an independent, open-source project licensed under AGPL-3.0.*
