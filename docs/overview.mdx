...
description: "Mineral Monitor platform variants, capabilities, and specialized monitoring configurations for geopolitical and technology intelligence."
---
Mineral Monitor runs five specialized variants from a single codebase, each optimized for different monitoring needs.
