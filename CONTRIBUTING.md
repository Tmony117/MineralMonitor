# Contributing to Mineral Monitor

Thank you for your interest in contributing to Mineral Monitor! This project thrives on community contributions — whether it's code, data sources, documentation, or bug reports.
...
Mineral Monitor is a real-time OSINT dashboard built with **Vanilla TypeScript** (no UI framework), **MapLibre GL + deck.gl** for map rendering, and a custom Proto-first RPC framework called **Sebuf** for all API communication.
...
- **Internationalization** — help make Mineral Monitor available in more languages
...
Thank you for helping make Mineral Monitor better! 🌍
