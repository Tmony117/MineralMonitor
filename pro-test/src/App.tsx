...
const Logo = () => (
  <a href="https://worldmonitor.app" className="flex items-center gap-2 hover:opacity-80 transition-opacity" aria-label="Mineral Monitor — Home">
    ...
    <div className="flex flex-col">
      <span className="font-display font-bold text-sm leading-none tracking-tight">Mineral Monitor</span>
    ...
    <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-start">
      ...
      <div className="bg-[#1a1d21] rounded-lg border border-[#35373b] overflow-hidden shadow-2xl sticky top-24">
        <div className="bg-[#222529] px-4 py-3 border-b border-[#35373b] flex items-center gap-3">
          ...
          <span className="ml-2 font-mono text-xs text-gray-400">#mineral-monitor-alerts</span>
        </div>
          ...
          <div className="flex gap-4">
            ...
            <div>
              <div className="flex items-baseline gap-2 mb-1">
                <span className="font-bold text-gray-200">Mineral Monitor</span>
  ...
  <footer className="border-t border-wm-border bg-[#020202] pt-8 pb-12 px-6 text-center">
    <div className="flex flex-col md:flex-row items-center justify-between max-w-7xl mx-auto text-xs text-wm-muted font-mono">
      <div className="flex items-center gap-3 mb-4 md:mb-0">
        ...
        <div className="flex flex-col">
          <span className="font-display font-bold text-sm leading-none tracking-tight text-wm-text">Mineral Monitor</span>
